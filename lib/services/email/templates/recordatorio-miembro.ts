        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:500px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:30px;">
              <h2 style="color:#1e293b;margin:0 0 15px;font-size:20px;">Tu membresía está por vencer</h2>
              ...
              <p style="color:#64748b;font-size:15px;line-height:1.6;margin:0 0 20px;">
                Tu membresía en <strong style="color:#1e293b;">${gymName}</strong> vence en <strong style="color:#f59e0b;">${diasRestantes} día${diasRestantes !== 1 ? "s" : ""}</strong> (${fechaVencimiento}).
              </p>
              <p style="color:#64748b;font-size:15px;line-height:1.6;margin:0 0 20px;">
                Para mantener tu acceso activo, por favor realiza tu pago antes de la fecha de vencimiento.
              </p>
