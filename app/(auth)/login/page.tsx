    ...
    <div className="min-h-screen flex items-center justify-center p-4 pb-16 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10 border-gym-primary/20 shadow-[0_0_40px_rgba(56,189,248,0.15)] animate-slideUp">
        ...
        <CardContent className="space-y-4">
          <button type="button" className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-gray-700 font-medium text-sm hover:bg-gray-50 hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed" onClick={handleGoogleLogin} disabled={loading}>
            {loading ? (
