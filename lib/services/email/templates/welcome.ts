...
export function welcomeTemplate(
  ...
  const confirmButtonHtml = confirmLink
    ? `<table width="100%" cellpadding="0" cellspacing="0" style="margin:20px 0 0;">
        <tr>
          <td>
            <a href="${confirmLink}" style="display:inline-block;background:linear-gradient(135deg,#38bdf8,#0ea5e9);color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:8px;font-size:14px;font-weight:bold;">
              Confirmar mi correo
            </a>
  ...
  if (password) {
    credentialsHtml = `
      ...
      <p style="color:#64748b;font-size:14px;line-height:1.6;margin:0 0 14px;">
...
<head>
  ...
  <style>
    @media only screen and (max-width:600px) {
      ...
      .welcome-col-left { width:100% !important; display:block !important; padding-right:0 !important; border-right:none !important; padding-bottom:20px !important; }
      .welcome-col-right { width:100% !important; display:block !important; padding-left:0 !important; border-left:none !important; border-top:1px solid #e2e8f0 !important; padding-top:20px !important; }
    }
  </style>
</head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:24px 24px 0;">
              <h2 style="color:#1e293b;margin:0 0 12px;font-size:18px;">¡Bienvenido!</h2>
              <p style="color:#64748b;font-size:14px;line-height:1.6;margin:0 0 6px;">Hola,</p>
            </td>
          </tr>
          <tr>
            <td style="padding:0 24px 24px;">
              <table width="100%" cellpadding="0" cellspacing="0" class="welcome-columns">
                <tr>
                  <td width="58%" valign="top" class="welcome-col-left" style="padding-right:20px;border-right:1px solid #e2e8f0;">
                    ${credentialsHtml}
                    ${confirmButtonHtml}
                  </td>
                  <td width="42%" valign="top" class="welcome-col-right" style="padding-left:20px;">
                    <p style="color:#64748b;font-size:12px;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;margin:0 0 12px;">Escanea para acceder</p>
                    <img src="cid:qr-login" alt="QR Acceso" width="120" height="120" style="display:block;margin:0 auto 10px;border-radius:8px;">
          ...
          <tr>
            <td style="padding:0 24px 24px;">
              ...
              <p style="color:#f59e0b;font-size:11px;line-height:1.5;margin:12px 0 0;background:#fffbeb;border:1px solid #fde68a;border-radius:6px;padding:10px 14px;">
                Si no recibes el correo, revisa tu bandeja de no deseados.
              </p>
              <p style="color:#cbd5e1;font-size:11px;line-height:1.5;margin:12px 0 0;">
