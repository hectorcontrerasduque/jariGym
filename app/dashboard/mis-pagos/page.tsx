            ...
            <div className="flex items-center gap-3">
              {miembroSeleccionado ? (
                ...
                <div className="flex-1 relative">
                  ...
                  />
                  {miembroSearch && (
                    <div className="absolute top-full left-0 right-0 mt-1 max-h-64 overflow-y-auto bg-gym-bg border border-gym-primary/50 rounded-xl z-50 shadow-lg shadow-gym-primary/20">
                    ...
                    {morosidad.mesesDeuda.map(mes => (
                      <div key={mes} className="flex items-center justify-between p-2.5 bg-gym-bg/60 rounded-xl">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] text-gym-muted">— Mensualidad</span>
                        </div>
