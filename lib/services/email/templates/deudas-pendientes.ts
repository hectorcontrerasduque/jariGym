        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:500px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:30px;">
              <h2 style="color:#1e293b;margin:0 0 15px;font-size:20px;">Pagos Pendientes</h2>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border-radius:8px;border:1px solid #e2e8f0;margin:0 0 20px;">
                <tr>
                  <td style="padding:16px;">
                    <p style="color:#64748b;font-size:13px;margin:0 0 8px;font-weight:bold;">Detalle de deudas:</p>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:8px 12px;border-bottom:2px solid #e2e8f0;color:#64748b;font-size:12px;font-weight:bold;">Período</td>
                        <td style="padding:8px 12px;border-bottom:2px solid #e2e8f0;color:#64748b;font-size:12px;font-weight:bold;text-align:right;">Monto</td>
                      </tr>
                      ${filasHtml}
                      <tr>
                        <td style="padding:12px;color:#1e293b;font-size:15px;font-weight:bold;">TOTAL</td>
                        <td style="padding:12px;color:#1e293b;font-size:15px;font-weight:bold;text-align:right;">$${totalDeuda.toFixed(2)}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
