export const messages = {
  ...
  miembros: {
    ...
    confirmarEliminar: "¿Eliminar a {nombre}? Esta acción no se puede deshacer.",
  ...
  configuracion: {
    ...
    propietarioDesc: "Con estos datos se crea acceso",
    ownerName: "Nombre",
    ownerEmail: "Correo (preferiblemente Gmail)",
    ...
    logoDelGym: "Logo del Gym",
    subirLogo: "Subir logo",
    cambiarLogo: "Cambiar",
    metodoEfectivo: "Efectivo",
    metodoBs: "Bolívares",
    metodoBinance: "Binance USDT",
    proximamente: "Próximamente",
    ajustesGenerales: "Ajustes generales del gym",
  },
  reportarPago: {
    title: "Reportar Pago",
  ...
  common: {
    ...
    creandoMiembro: "Creando miembro...",
    actualizandoMembresia: "Actualizando membresía...",
    cambiandoRol: "Cambiando rol...",
    actualizandoEstado: "Actualizando estado...",
    guardandoMembresia: "Guardando membresía...",
    guardandoNota: "Guardando nota...",
    enviandoPago: "Enviando pago...",
    enviandoNotificaciones: "Enviando notificaciones...",
    ejecutandoDiagnostico: "Ejecutando diagnóstico...",
  },
  toast: {
    ...
    soloImagenes: "Solo se permiten imágenes",
    logoActualizado: "Logo actualizado",
    logoErrorSubir: "Error al subir logo",
    logoEliminado: "Logo eliminado",
    logoErrorEliminar: "Error al eliminar logo",
    errorCambiarRol: "Error al cambiar rol",
    notasGuardadas: "Notas actualizadas",
    notasError: "Error al guardar notas",
    errorCargarMorosos: "Error al cargar morosos",
    correoFormatoInvalido: "Formato de correo inválido",
    guardando: "Guardando...",
  },
  migracion: {
    ...
    nombrePlaceholder: "Escriba para buscar su nombre...",
    phoneNumber: "WhatsApp (opcional)",
    correo: "Correo electrónico (preferiblemente Gmail)",
    ...
    camposRequeridos: "Nombre y correo son requeridos",
    metodoPagoNoConfigurado: "No hay método de pago configurado. Vaya a Configuración y agregue un método de pago antes de migrar.",
    montoMensualCero: "El monto mensual del método de pago es 0. Configure el monto antes de migrar.",
    sinRegistrosMigrables: "No hay registros migrables para este miembro. Verifique que tenga meses pagados en la tabla de migración.",
  ...
  notificaciones: {
    ...
    modoCobroDesc: "Define cuándo se cobra la mensualidad a cada miembro.",
    modoCobroDiaUno: "Día 1 de cada mes",
    modoCobroFechaInscripcion: "Según fecha de inicio",
