...
export function pagoAprobadoTemplate(
  memberName: string,
  gymName: string,
  monto: number,
  ...
  const logoHtml = gymLogo
    ...
    : `<div style="width:60px;height:60px;background:linear-gradient(135deg,#22c55e,#16a34a);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:28px;font-weight:bold;color:#ffffff;">✓</div>`;
...
<head>
  ...
  <title>Pago Aprobado - ${gymName}</title>
</head>
<body style="margin:0;padding:0;background-color:#f4f4f5;font-family:Arial,sans-serif;">
  <div style="display:none;font-size:1px;color:#f4f4f5;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
    Tu pago de $${monto.toFixed(2)} ha sido aprobado en ${gymName}.
  </div>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:500px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:30px;">
              <h2 style="color:#22c55e;margin:0 0 15px;font-size:20px;">✅ Pago Aprobado</h2>
              ...
              <p style="color:#64748b;font-size:15px;line-height:1.6;margin:0 0 20px;">
                Tu pago ha sido <strong style="color:#22c55e;">aprobado</strong> exitosamente.
              </p>
                ...
                <tr>
                  <td style="padding:16px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:6px 0;color:#64748b;font-size:13px;">Fecha de aprobación:</td>
                        <td style="padding:6px 0;color:#1e293b;font-size:14px;text-align:right;">${new Date().toLocaleDateString("es-VE")}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <a href="${process.env.NEXT_PUBLIC_SITE_URL}/dashboard/mis-pagos" style="display:inline-block;background:linear-gradient(135deg,#22c55e,#16a34a);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-size:16px;font-weight:bold;">
                      Ver mis pagos
                    </a>
                  </td>
                </tr>
